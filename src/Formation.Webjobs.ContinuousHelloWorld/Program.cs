    ...
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            builder.ConfigureServices((context, services) =>
            {
                ...
                services.Configure<SubscriptionNamesSettings>(context.Configuration.GetSection("SubscriptionNames"));

                // Configuration des services
                services.AddSingleton<INameResolver, AppSettingsSubscriptionNameResolver>();
            });
            ...
            using (host)
            {
                // Exécute continuellement l'hôte du webjob
                await host.RunAsync();
            }
        }
    }
